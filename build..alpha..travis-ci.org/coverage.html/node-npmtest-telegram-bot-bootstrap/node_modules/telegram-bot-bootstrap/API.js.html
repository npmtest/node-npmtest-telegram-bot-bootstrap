...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-telegram-bot-bootstrap/node_modules/telegram-bot-bootstrap/API.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-telegram-bot-bootstrap">npmtest-telegram-bot-bootstrap (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-telegram-bot-bootstrap/node_modules/telegram-bot-bootstrap/API.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-telegram-bot-bootstrap/node_modules/telegram-bot-bootstrap/</a> &#187; API.js</div>
</div>
<div class="body">
 ...
 * 
 */
var API = <span class="fstat-no" title="function not covered" >function(token) {</span>
<span class="cstat-no" title="statement not covered" >    this.token = token;</span>
<span class="cstat-no" title="statement not covered" >    this.baseUrl = 'https://api.telegram.org/bot' + this.token;</span>
&nbsp;
    // A sample Telegram bot JSON data, for req options
<span class="cstat-no" title="statement not covered" >    this.formData = {</span>
        chat_id: "87654321",
        text: "Hello there"
    };
&nbsp;
    // template options for req the Telegram Bot API
<span class="cstat-no" title="statement not covered" >    this.baseoptions = {</span>
        method: 'POST',
...
<span class="cstat-no" title="statement not covered" >    this.toHTTPProper = <span class="fstat-no" title="function not covered" >function(data) {</span></span>
        // currently serialize Array now, leave stream/string
<span class="cstat-no" title="statement not covered" >        return _.isArray(data) ? JSON.stringify(data) : data;</span>
        // return data;
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.serialize = <span class="fstat-no" title="function not covered" >function(obj) {</span></span>
        // var ser = _.omit(
        //     _.mapValues(_.flattenJSON(obj), this.toHTTPProper)
        //     , _.isUndefined);
<span class="cstat-no" title="statement not covered" >        var ser = _.omit(</span>
            _.mapValues(obj, this.toHTTPProper)
            , _.isUndefined);
<span class="cstat-no" title="statement not covered" >        if (!_.isEmpty(ser)) <span class="cstat-no" title="statement not covered" >return ser;</span></span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.extOpt = <span class="fstat-no" title="function not covered" >function(botMethod, JSONdata, HTTPMethod) {</span></span>
<span class="cstat-no" title="statement not covered" >        var opt = _.clone({</span>
            method: 'POST',
            baseUrl: this.baseUrl,
            url: "sendMessage",
            formData: this.formData
        });
<span class="cstat-no" title="statement not covered" >        _.assign(opt, {</span>
            url: botMethod
        })
<span class="cstat-no" title="statement not covered" >        if (JSONdata) <span class="cstat-no" title="statement not covered" >_.assign(opt, {</span></span>
            formData: this.serialize(JSONdata)
        })
<span class="cstat-no" title="statement not covered" >        if (HTTPMethod) <span class="cstat-no" title="statement not covered" >_.assign(opt, {</span></span>
...
<span class="cstat-no" title="statement not covered" >    this.reqBot = _.flow(this.extOpt, this.req)</span>
&nbsp;
}
&nbsp;
&nbsp;
 ...
 * 
 */
API.prototype.getUpdates = <span class="fstat-no" title="function not covered" >function(first, limit, timeout) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            offset: first,
            limit: limit,
            timeout: timeout
        };
<span class="cstat-no" title="statement not covered" >    return this.reqBot('getUpdates', options)</span>
}
&nbsp;
/**
 ...
 */
API.prototype.setWebhook = <span class="fstat-no" title="function not covered" >function(first) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            url: first
        };
<span class="cstat-no" title="statement not covered" >    return this.reqBot('setWebhook', options);</span>
}
&nbsp;
/**
 ...
 */
API.prototype.getMe = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return this.reqBot('getMe');</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendMessage = <span class="fstat-no" title="function not covered" >function(first, text, disable_web_page_preview, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendMessage', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.forwardMessage = <span class="fstat-no" title="function not covered" >function(first, from_chat_id, message_id) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('forwardMessage', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendPhoto = <span class="fstat-no" title="function not covered" >function(first, photo, caption, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            photo: photo,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendPhoto', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendAudio = <span class="fstat-no" title="function not covered" >function(first, audio, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            audio: audio,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendAudio', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendDocument = <span class="fstat-no" title="function not covered" >function(first, document, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            document: document,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendDocument', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendSticker = <span class="fstat-no" title="function not covered" >function(first, sticker, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            sticker: sticker,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendSticker', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendVideo = <span class="fstat-no" title="function not covered" >function(first, video, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            video: video,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendVideo', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendLocation = <span class="fstat-no" title="function not covered" >function(first, latitude, longitude, reply_to_message_id, reply_markup) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            longitude: longitude,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendLocation', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.sendChatAction = <span class="fstat-no" title="function not covered" >function(first, action) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            chat_id: first,
            action: action
        };
<span class="cstat-no" title="statement not covered" >    return this.reqBot('sendChatAction', options);</span>
}
&nbsp;
/**
 ...
 * 
 */
API.prototype.getUserProfilePhotos = <span class="fstat-no" title="function not covered" >function(first, offset, limit) {</span>
<span class="cstat-no" title="statement not covered" >    var options = _.isObject(first) ?</span>
        first : {
            user_id: first,
            offset: offset,
...
<span class="cstat-no" title="statement not covered" >    return this.reqBot('getUserProfilePhotos', options);</span>
}
&nbsp;
/**
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 13:30:38 GMT+0000 (UTC)</div>
</div>
</body>
</html>
